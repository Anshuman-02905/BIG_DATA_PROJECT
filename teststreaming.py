...
loaded_model_lm=pickle.load(open('saved_models/model_lm_1000.sav', 'rb'))
loaded_model_sgd=pickle.load(open('saved_models/model_sgd_1000.sav', 'rb'))
loaded_model_mlp=pickle.load(open('saved_models/model_mlp_1000.sav', 'rb'))
